...
const server ="https://authentication-tz5b.onrender.com"
...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    if (errorCode.startsWith("CSRF_")) {
      return handleRefresh("csrf", "/api/user/refresh-csrf", originalRequest);
    }

    return handleRefresh("auth", "/api/user/refresh", originalRequest);
  }
);
